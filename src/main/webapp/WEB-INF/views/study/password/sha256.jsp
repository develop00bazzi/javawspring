...
<p><br/></p>
<div class="container">
	<h2>SHA-256 암호화 방식</h2>
	<p>
		SHA256은 SHA(Secure Hash Algorithm) 알고리즘의 한 종류로써 256 비트로 구성되며 64자리 문자열로 구성된다. <br/>
		SHA256은 단방향 암호화 방식이기에 복호화가 불가능하고, 속도가 빠르다는 장점이 있다. <br/>
	</p>
	...
	<p>
		...
		<input type="button" value="SHA256 암호화" onclick="sha256Check()" class="btn btn-secondary" />
