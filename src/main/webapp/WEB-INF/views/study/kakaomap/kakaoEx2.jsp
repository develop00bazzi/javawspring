	...
	<div>
		<form name="myform">
			<div>
				...
				<input type="button" value="지역 검색" onclick="addressSearch()" class="btn btn-secondary"/>
				<input type="button" value="검색 지역 DB 삭제" onclick="addressDelete()" class="btn btn-secondary"/>
