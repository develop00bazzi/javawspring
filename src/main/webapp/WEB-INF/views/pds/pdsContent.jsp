...
<div class="container">
  ...
  <div class="text-center">
    <input type="button" value="돌아가기" onclick="location.href='${ctp}/pds/pdsList?part=${pageVo.part}&pag=${pageVo.pag}&pageSize=${pageVo.pageSize}&flag=${pageVo.flag}&search=${pageVo.search}&searchString=${pageVo.searchString}';" class="btn btn-secondary"/>
  </div>
  <hr/>
  <div class="text-center">
	  <c:set var="fSNames" value="${fn:split(vo.FSName,'/')}"/>
