...
<p><br/></p>
<div class="container">
	<h2 class="text-center">방 명 록 글 올 리 기</h2>
	<form name="myform" method="post" class="was-validated">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="email" placeholder="이메일 입력은 선택사항입니다." name="email" >
	  </div>
	  <div class="form-group">
	    <label for="homePage">개인 홈페이지 주소</label>
	    <input type="text" class="form-control" id="homePage" value="http://" placeholder="개인 홈페이지 주소는 선택사항입니다." name="homePage" >
	  </div>
	  <div class="form-group">
